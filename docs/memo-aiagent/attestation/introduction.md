...
The Ethereum Attestation Service (EAS) was created to address this. EAS is a data attestation system based on distributed ledger or other decentralized technologies, ensuring data authenticity. EAS allows any entity to attest to anything, thereby providing a guarantee of its authenticity.
...
EAS allows anyone to make on-chain or off-chain attestations about anything. You only need to register a schema on any topic (or use an existing one) and then reference that schema to make an attestation.
