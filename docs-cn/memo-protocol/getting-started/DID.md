...
go-did是由golang语言实现的SDK：[did-go-sdk](https://github.com/memoio/did-go-sdk)，可以支持创建，查询，删除以及修改DID。
...
可根据[使用文档](https://github.com/memoio/did-go-sdk/blob/master/README_cn.md)中说明进行操作。
...
需要您从[did-js-sdk](https://github.com/memoio/did-js-sdk#)上下载

## 使用js-did

可根据[使用文档](https://github.com/memoio/did-js-sdk/blob/master/README_cn.md)中说明进行操作。
